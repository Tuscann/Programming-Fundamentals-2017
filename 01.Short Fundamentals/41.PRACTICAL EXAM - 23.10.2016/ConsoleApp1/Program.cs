...
internal class Program
{
    public static void Main() // 100/100
    {
        ...
        decimal maxPossibleRunners = Math.Min(runnerCount, trackCapacity * days);
        decimal kilometers = maxPossibleRunners * averageNumber * lapLenght / 1000;
        decimal moneyraised = kilometers * moneyPerKilimeter;
